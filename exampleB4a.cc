...
int main(int argc,char** argv)
{
  ...
  // Set particle colors
  G4TrajectoryDrawByParticleID* trajColors = new G4TrajectoryDrawByParticleID;
  trajColors->SetDefault("red");
  trajColors->Set("gamma", "yellow");
  trajColors->Set("neutron", "green");
  trajColors->Set("e-", "white");
  trajColors->Set("opticalphoton", "blue");
  visManager->RegisterModel(trajColors);
